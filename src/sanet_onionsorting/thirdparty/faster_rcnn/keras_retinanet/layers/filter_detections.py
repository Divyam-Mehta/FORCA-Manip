...
def filter_detections(
    ...
    labels              = indices[:, 1]
    scores, top_indices = backend.top_k(scores, k=keras.backend.minimum(max_detections, tensorflow.keras.backend.shape(scores)[0]))
    ...
    pad_size = keras.backend.maximum(0, max_detections - tensorflow.keras.backend.shape(scores)[0])
