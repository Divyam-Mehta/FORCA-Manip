...
//   move_group.startStateMonitor();
  ...
  while (rclcpp::ok())
  {
    ...
    while(!robot_goal_reached)   // One whole Pass of PSort
    {
        ...
        double robot_distance_threshold = 0.3;
        ...
        // Plan for those Goal Position using Baseline
...
//     ur1_planning_group, ur2_planning_group, ur3_planning_group, ur4_planning_group
//   };
  
//   allowInterRobotCollisions(node, kinematic_model, groups);
...
//   std::vector<double> ur4_inspect_approach = {1.04, 0.63, 1.0, 1.61, 0, 3.14};
  ...
  ur1_move_group.setMaxVelocityScalingFactor(0.9);
  ur1_move_group.setMaxAccelerationScalingFactor(0.9);
  ...
  ur2_move_group.setMaxVelocityScalingFactor(0.9);
  ur2_move_group.setMaxAccelerationScalingFactor(0.9);
  ...
  ur3_move_group.setMaxVelocityScalingFactor(0.9);
  ur3_move_group.setMaxAccelerationScalingFactor(0.9);
  ...
  ur4_move_group.setMaxVelocityScalingFactor(0.9);
  ur4_move_group.setMaxAccelerationScalingFactor(0.9);
